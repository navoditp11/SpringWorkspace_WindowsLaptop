package com.gl.rbawiththymeleaf.security;
...
import com.gl.rbawiththymeleaf.service.FetchPrincipalFormDb;
...
public class MyWebSecurity extends WebSecurityConfigurerAdapter{
	...
	@Bean
	public AuthenticationProvider myGlAuthPro() {
	...
	public UserDetailsService myGlUserDetails() { //Decorated UserDetails
		return new FetchPrincipalFormDb();
	}
